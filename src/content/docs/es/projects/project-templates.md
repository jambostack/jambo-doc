...
Les templates de proyecto sont des schémas pré-construits que vous pouvez appliquer lors de la création d'un nouveau proyecto. Ils vous fournissent une structure de coleccións prête à l'emploi.

## Plantillas disponibles

### Blog

- **Articles** — titre, slug, corps richtext, extrait, image à la une, auteur (relation → end_users), publicado_le
...
- **Proyectos** — titre, slug, description, image de couverture, galerie, tags, année, client
...
- **Membres de l'équipe** — nom, rol, bio, avatar, linkedin_url

## Appliquer un template

1. Cliquez sur **+ Nouveau proyecto**
...
Pour les structures personnalisées non couvertes par les templates, utilisez le [Studio IA](/es/studio/schema-builder/) pour décrire vos besoins en langage naturel et générer un schéma sur mesure en quelques secondes.
