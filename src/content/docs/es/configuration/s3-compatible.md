...
Consultez [Configuration AWS S3](/es/configuration/aws-s3/) pour la politique de bucket et la configuration CORS — elles s'appliquent à tous les providers compatibles S3.
